...
O canvas agora ocupa a maior área 16:9 disponível no navegador. A câmera possui margem além da borda norte para manter o personagem em uma zona de leitura confortável, o inventário sempre mostra a aparência atual de frente e o nome/comando dos NPCs foi reunido numa única placa discreta. A barra inferior recebeu arte própria, orbes de HP/Mana que diminuem com os valores reais, comandos compactos e oito espaços de habilidade. Consulte `ROUND67_CITY_POLISH_PASS.md` para o passe atual e `HISTORICO_E_REFERENCIAS_ATE_ROUND66.md` para todos os documentos anteriores.
