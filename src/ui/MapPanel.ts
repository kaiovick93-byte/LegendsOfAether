...
export class MapPanel{
 ...
 refreshMarkerVisibility(){for(const view of this.markerViews){const visible=this.markerAllowed(view.marker);view.halo.setVisible(visible);view.dot.setVisible(visible);view.label.setVisible(visible)}}
