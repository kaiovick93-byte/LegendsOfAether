...
export const PLAYER_APPEARANCES={
 warrior_m:{id:'warrior_m',classId:'warrior',gender:'male',genderLabel:'Masculino',heritage:'Negro',label:'Guerreiro negro'},
 warrior_f:{id:'warrior_f',classId:'warrior',gender:'female',genderLabel:'Feminino',heritage:'Asiática',label:'Guerreira asiática'},
 mage_m:{id:'mage_m',classId:'mage',gender:'male',genderLabel:'Masculino',heritage:'Asiático',label:'Mago asiático'},
 mage_f:{id:'mage_f',classId:'mage',gender:'female',genderLabel:'Feminino',heritage:'Negra',label:'Maga negra'},
 ranger_m:{id:'ranger_m',classId:'ranger',gender:'male',genderLabel:'Masculino',heritage:'Caucasiano',label:'Caçador caucasiano'},
 ranger_f:{id:'ranger_f',classId:'ranger',gender:'female',genderLabel:'Feminino',heritage:'Asiática',label:'Caçadora asiática'}
};
