...
export const ITEMS={
 ...
 iron_sword:{id:'iron_sword',name:'Espada de Ferro',type:'weapon',allowedClass:'warrior',weaponFamily:'sword',rarity:'common',value:70,description:'+4 ataque • somente Guerreiro',stats:{attack:4}},
 hunter_bow:{id:'hunter_bow',name:'Arco do Batedor',type:'weapon',allowedClass:'ranger',weaponFamily:'bow',rarity:'common',value:75,description:'+4 ataque • somente Caçador',stats:{attack:4}},
 apprentice_staff:{id:'apprentice_staff',name:'Cajado de Aprendiz',type:'weapon',allowedClass:'mage',weaponFamily:'staff',rarity:'common',value:75,description:'+3 ataque, +5 mana • somente Mago',stats:{attack:3,mana:5}},
 ...
 wraith_blade:{id:'wraith_blade',name:'Lâmina Espectral',type:'weapon',allowedClass:'warrior',weaponFamily:'sword',rarity:'epic',value:280,description:'+9 ATK, +2 velocidade • somente Guerreiro',stats:{attack:9,speed:2}},
 royal_mage_staff:{id:'royal_mage_staff',name:'Cajado da Coroa',type:'weapon',allowedClass:'mage',weaponFamily:'staff',rarity:'epic',value:320,description:'+11 ATK, +20 mana • somente Mago',stats:{attack:11,mana:20}},
...
export function getRandomDropDefinition(){const pool=['healing_potion','mana_potion','iron_sword','hunter_bow','apprentice_staff','elder_talisman'];return getItemDefinition(pool[Math.floor(Math.random()*pool.length)])}
