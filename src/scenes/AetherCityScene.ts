...
export class AetherCityScene extends Phaser.Scene {
  ...
  configurePlayerVisual() {
    ...
    const playerVisualScale=this.player.appearanceId==='mage_f'?0.94:1.28;
  ...
  createWallsAndGates() {
    ...
    this.southGateSprite = new IsoSprite({
      scene:this,isoX:14,isoY:26.03,isoZ:gateBaseIsoZ,
  ...
  addBrokenGoblinRamOutsideCity() {
    ...
    const ram = this.addIsoImage('iso_goblin_battering_ram_broken', 28.18, 19.92, 164, .055, 6);
    const footprint = {u1:27.55,v1:19.08,u2:29.05,v2:20.86,corner:.18};
  ...
  addWallRun(fixedAxis, fixed, start, end, flip) {
    ...
    for (let index = 0; index < count; index++) {
      ...
      const image = new IsoSprite({
        scene:this,isoX:u,isoY:v,isoZ:wallBaseIsoZ,
