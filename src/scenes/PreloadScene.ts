...
export class PreloadScene extends Phaser.Scene{
  ...
  preload(){
    ...
    this.load.image('iso_city_pavement_v2','assets/images/environment/isometric/isometric_city_pavement_v2.png');
    this.load.image('iso_city_streets','assets/images/environment/isometric/isometric_city_streets.png');
