...
export class PreloadScene extends Phaser.Scene{
  ...
  preload(){
    ...
    this.load.image('city_pavement','assets/images/environment/city/city_pavement.png');
    this.load.image('city_grass','assets/images/environment/city/city_grass.png');
    ...
    this.load.image('iso_city_wall_corner','assets/images/environment/isometric/isometric_city_wall_corner.png');
