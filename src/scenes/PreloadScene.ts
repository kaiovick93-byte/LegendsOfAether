...
export class PreloadScene extends Phaser.Scene{
  ...
  preload(){
    ...
    this.load.image('old_road_straight_v3','assets/images/environment/outskirts/old-road-v3/old_road_straight_v3.png');
    this.load.image('old_road_curve_v3','assets/images/environment/outskirts/old-road-v3/old_road_curve_v3.png');
    this.load.image('old_road_junction_v3','assets/images/environment/outskirts/old-road-v3/old_road_junction_v3.png');
    this.load.image('old_road_transition_v3','assets/images/environment/outskirts/old-road-v3/old_road_transition_v3.png');
    this.load.image('old_road_damaged_v3','assets/images/environment/outskirts/old-road-v3/old_road_damaged_v3.png');
    this.load.image('old_road_grass_v3','assets/images/environment/outskirts/old-road-v3/old_road_grass_v3.png');
    this.load.image('old_road_creek_bank_v3','assets/images/environment/outskirts/old-road-v3/old_road_creek_bank_v3.png');
    this.load.image('old_road_embankment_v3','assets/images/environment/outskirts/old-road-v3/old_road_embankment_v3.png');
    this.load.image('old_road_ground_base_a_v4','assets/images/environment/outskirts/old-road-v3/old_road_ground_base_a_v4.png');
    this.load.image('old_road_ground_base_b_v4','assets/images/environment/outskirts/old-road-v3/old_road_ground_base_b_v4.png');
    this.load.image('old_road_ground_worn_v4','assets/images/environment/outskirts/old-road-v3/old_road_ground_worn_v4.png');
    this.load.image('old_road_connector_long_v4','assets/images/environment/outskirts/old-road-v3/old_road_connector_long_v4.png');
    this.load.image('old_road_connector_short_v4','assets/images/environment/outskirts/old-road-v3/old_road_connector_short_v4.png');
    this.load.image('old_road_mature_oak_v3','assets/images/environment/outskirts/old-road-v3/old_road_mature_oak_v3.png');
