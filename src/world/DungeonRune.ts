...
export class DungeonRune extends Phaser.GameObjects.Container {
  constructor(scene,x,y,dungeonName,regionName){
    ...
    this.prompt=scene.add.text(0,-55,'F • Ler Runa',{fontFamily:'Arial',fontSize:11,color:'#ffd166',backgroundColor:'#182033',padding:{left:5,right:5,top:3,bottom:3}}).setOrigin(.5).setVisible(false);
