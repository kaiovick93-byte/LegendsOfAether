...
// A Estrada Velha é terreno, não um objeto oclusor. Ela precisa usar uma
// camada estável, enquanto atores e objetos altos preservam o depth pelos pés.
assert(
  territory.includes('AETHER_TERRITORY_RENDER_LAYERS=Object.freeze({TERRAIN:-80,ROAD:-70})')&&
  territory.includes('addGround(texture,u,v')&&
  territory.includes('const OLD_ROAD_GROUND_KIT=Object.freeze')&&
  territory.includes('createOldRoadGround()')&&
  territory.includes('this.addGround(key,u,v,scale')&&
  !territory.includes('this.stampPolyline(AETHER_OLD_ROAD,.53,2.25,true)'),
  'Estrada Velha ainda participa do depth dinâmico como oclusor.'
);
